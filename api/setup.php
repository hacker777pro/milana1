...
// 1. Создаём таблицы (IF NOT EXISTS = НЕ трогает, если уже есть)
$pdo->exec("
...
// 2. Добавляем товары ТОЛЬКО если база пустая
...
if ($count == 0) {
    ...
    echo '✅ Создана новая база. Добавлено 6 товаров.';
} else {
    echo 'ℹ️ База уже существует. Товаров: ' . $count . '. Ничего не удалялось и не дублировалось.';
}
?>